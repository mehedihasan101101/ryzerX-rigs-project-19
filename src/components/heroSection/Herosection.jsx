...
const Herosection = () => {
    return (
        <>
            <div className="lg:max-w-[90%] max-w-[98%] m-auto px-4  bg-gray-200 rounded-2xl flex flex-col items-center space-y-5 pt-30 lg:pb-75 md:pb-60 pb-33 mt-[-80px] lg:mt-[-97px]">
